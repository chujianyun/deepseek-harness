...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /**
     * The single frame-wide background behind sidebar, conversation, and
     * details. The layer fills AppFrame and never receives pointer events;
     * shell.overlay and drag handles remain above both the background and
     * columns. Registering here replaces the complete background contribution.
     *
     * The frame keeps its normal theme background when the seat is empty.
     * Disposing the occupant removes its rendered background immediately and
     * exposes that unchanged fallback without requiring theme coordination.
     */
